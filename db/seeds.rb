...
segment4.user_segments.create!(user_id: user1.id, pr: 0, perf_perc: segment4.kom_time / 0.to_f)
segment5.user_segments.create!(user_id: user1.id, pr: 792, perf_perc: segment5.kom_time / 792.to_f)
segment6.user_segments.create!(user_id: user1.id, pr: 0, perf_perc: segment6.kom_time / 0.to_f)
...
segment1.user_segments.create!(user_id: user2.id, pr: 0, perf_perc: segment1.kom_time / 0.to_f)
...
segment6.user_segments.create!(user_id: user2.id, pr: 0, perf_perc: segment6.kom_time / 0.to_f)
segment7.user_segments.create!(user_id: user2.id, pr: 0, perf_perc: segment7.kom_time / 0.to_f)
